...
import { handleAddGovernmentals } from "../../Store/governmental.slice";

interface FormValues {
  reportExcel: File | null;
}

const AddGovernmentals: React.FC = () => {
    ...
    <div>
      ...
      <Formik
        ...
        onSubmit={async (values) => {
          ...
          const data = await dispatch(handleAddGovernmentals(formData));
          setIsLoading(false);
...
export default AddGovernmentals;
